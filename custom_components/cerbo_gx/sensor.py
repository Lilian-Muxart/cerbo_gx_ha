...
from .mqtt_client import CerboMQTTClient  # Client MQTT importé
...
class CerboBaseSensor(SensorEntity):
    ...
    def on_mqtt_message(self, client, userdata, msg):
        ...
        try:
            ...
            if msg.topic == self.get_state_topic():
...
class CerboBatterySensor(CerboBaseSensor):
    ...
    def __init__(self, device_name: str, id_site: str, mqtt_client: CerboMQTTClient):
        ...
        value_key = "soc"  # Extraction de la charge de la batterie
...
# Capteurs pour Voltage et Température sont configurés de manière similaire.
